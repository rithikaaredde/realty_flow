...
router.get("/:cognitoId", authMiddleware_1.authenticate, tenantController_1.getTenantProfile);
router.put("/:cognitoId", authMiddleware_1.authenticate, tenantController_1.updateTenantProfile);
